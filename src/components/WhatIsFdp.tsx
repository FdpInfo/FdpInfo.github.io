...
const FEATURE_PATHS = [
  "M7.999 2.34a4.733 4.733 0 0 0-6.604 6.778l5.904 5.762a1 1 0 0 0 1.4 0l5.915-5.77a4.733 4.733 0 0 0-6.615-6.77Zm5.208 5.348-5.208 5.079-5.2-5.07a2.734 2.734 0 0 1 3.867-3.864c.182.19.335.404.455.638a1.04 1.04 0 0 0 1.756 0 2.724 2.724 0 0 1 5.122 1.294 2.7 2.7 0 0 1-.792 1.923Z",
  "M11 0c1.3 0 2.6.5 3.5 1.5 1 .9 1.5 2.2 1.5 3.5 0 1.3-.5 2.6-1.4 3.5l-1.2 1.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l1.1-1.2c.6-.5.9-1.3.9-2.1s-.3-1.6-.9-2.2C12 1.7 10 1.7 8.9 2.8L7.7 4c-.4.4-1 .4-1.4 0-.4-.4-.4-1 0-1.4l1.2-1.1C8.4.5 9.7 0 11 0ZM8.3 12c.4-.4 1-.5 1.4-.1.4.4.4 1 0 1.4l-1.2 1.2C7.6 15.5 6.3 16 5 16c-1.3 0-2.6-.5-3.5-1.5C.5 13.6 0 12.3 0 11c0-1.3.5-2.6 1.5-3.5l1.1-1.2c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4L2.9 8.9c-.6.5-.9 1.3-.9 2.1s.3 1.6.9 2.2c1.1 1.1 3.1 1.1 4.2 0L8.3 12Zm1.1-6.8c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-4.2 4.2c-.2.2-.5.3-.7.3-.2 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l4.2-4.2Z",
  "M14 0a2 2 0 0 1 2 2v4a1 1 0 0 1-2 0V2H2v12h4a1 1 0 0 1 0 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12Zm-1.957 10.629 3.664 3.664a1 1 0 0 1-1.414 1.414l-3.664-3.664-.644 2.578a.5.5 0 0 1-.476.379H9.5a.5.5 0 0 1-.48-.362l-2-7a.5.5 0 0 1 .618-.618l7 2a.5.5 0 0 1-.017.965l-2.578.644Z",
  "M14.3.3c.4-.4 1-.4 1.4 0 .4.4.4 1 0 1.4l-8 8c-.2.2-.4.3-.7.3-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4l8-8ZM15 7c.6 0 1 .4 1 1 0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8c.6 0 1 .4 1 1s-.4 1-1 1C4.7 2 2 4.7 2 8s2.7 6 6 6 6-2.7 6-6c0-.6.4-1 1-1Z",
];

export function WhatIsFdp() {
  const { t } = useI18n();
  const FEATURES = FEATURE_PATHS.map((path, i) => ({
    path,
    title: t.whatIsFdp.features[i].title,
    desc: t.whatIsFdp.features[i].desc,
  }));
  return (
                    ...
                    <div className="display-flex flex-direction-column flex-linha-horizontal alinhar-itens-no-centro justificar-conteudo-com-espacamento">
                      ...
                      <div className="ordem-1 flex-encolher-0 padding-1-5rem padding-top-0px media-ordem-padrao media-largura-max-480px padding-total-2rem padding-direito-0px">
                        <div className="margem-inferior-1-25rem">
                          <div>
                            <h3 className={H3}> {t.whatIsFdp.cleanestGuiTitle}</h3>
                            <p className="text-color-gray-300">
                              {t.whatIsFdp.cleanestGuiDesc}
                            </p>
                          </div>
                        </div>
                        <div>
                  ...
                  <div className="zywl-relativo z-index-20 altura-100-porcento overflow-hidden border-radius-inherit bg-color-rgb">
                    <div className="display-flex flex-direction-column">
                      ...
                      <div className="ordem-1 flex-encolher-0 padding-1-5rem padding-top-0px media-ordem-padrao media-largura-max-480px padding-total-2rem">
                        <div>
                          <h3 className={H3}> {t.whatIsFdp.featureFilledTitle}</h3>
                          <p className="text-color-gray-300">
                            {t.whatIsFdp.featureFilledDesc}{" "}
                          </p>
                        </div>
                      </div>
                ...
                <div className={CARD}>
                  <div className="zywl-relativo z-index-20 altura-100-porcento overflow-hidden border-radius-inherit bg-color-rgb">
                    <div className="display-flex flex-direction-column">
                      ...
                      <div className="ordem-1 flex-encolher-0 padding-1-5rem padding-top-0px media-ordem-padrao media-largura-max-480px padding-total-2rem">
                        <div>
                          <h3 className={H3}> {t.whatIsFdp.customizableTitle}</h3>
                          <p className="text-color-gray-300">
                            {t.whatIsFdp.customizableDesc}
                          </p>
                        </div>
                      </div>
                      <div className="zywl-relativo altura-16rem largura-100porcento overflow-hidden media-altura-automatica padding-bottom-2rem">
          ...
          <div className="exibir-grade espacamento-2rem grade-colunas-3 espaco-entre-elementos-3rem">
            ...
            <div>
              <div className="mb-0-25rem display-flex alinhar-itens-centro margem-x-automatica">
                ...
                <h4 className="font-weight-500 text-color-gray-50">{t.whatIsFdp.securityTitle}</h4>
              </div>
              <p className="font-size-0-875rem text-color-gray-300">
                {t.whatIsFdp.securityBefore}{" "}
                <b>
                  <Link href="/privacy">{t.whatIsFdp.securityLink}</Link>
                </b>
                {t.whatIsFdp.securityAfter}{" "}
              </p>
            </div>
            <div>
              <div className="mb-0-25rem display-flex alinhar-itens-centro margem-x-automatica">
                ...
                <h4 className="font-weight-500 text-color-gray-50">
                  {t.whatIsFdp.translationTitle}
                </h4>
              </div>
              <p className="font-size-0-875rem text-color-gray-300">
                {t.whatIsFdp.translationDesc}
              </p>
            </div>
          </div>
        </div>
