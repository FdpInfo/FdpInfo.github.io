    ...
    <div className="hub-grid">
      ...
      <a className="hub-card" href={discord}>
        <CardBody
          ...
          title={t.communityCards.discord.title}
          desc={t.communityCards.discord.desc}
          cta={t.communityCards.discord.cta}
        />
      </a>
      ...
      >
        <CardBody
          ...
          title={t.communityCards.changelog.title}
          desc={t.communityCards.changelog.desc}
          cta={t.communityCards.changelog.cta}
        />
      </a>
      ...
      >
        <CardBody
          ...
          title={t.communityCards.bug.title}
          desc={t.communityCards.bug.desc}
          cta={t.communityCards.bug.cta}
        />
      </a>
      ...
      <Link className="hub-card" href="/donate">
        <CardBody
          ...
          title={t.communityCards.support.title}
          desc={t.communityCards.support.desc}
          cta={t.communityCards.support.cta}
        />
      </Link>
    </div>
  );
